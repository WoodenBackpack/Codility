...
class Poem():
  ...
  def __str__(self):
    ...
    # without it print(Poem("Ujejski", "Choral", "???") will return a object instead of string
    # <class '__main__.Poem'> ...
    # ie Krzysztof Kamil Baczynski Biala Magia
...
if __name__ == '__main__':
  ...
  for poem in createPoemsFromDirectory():
    ...
    with open(poem.title.replace(" ","") + "_" + poem.author.replace(" ", "") + ".txt", "w") as outputFile:
      # Opens file with name ie: "KrzysztofKamilBaczynski_Bialamagia.txt"
